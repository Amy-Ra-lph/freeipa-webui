      ...
      if ("data" in response) {
        ...
        if (data?.result) {
          ...
          dispatch(
            addAlert({
              name: "success",
              title: "Workload '" + props.workload.cn + "' updated",
              variant: "success",
            })
          );
          props.onResetValues();
  ...
  const toolbarFields = [
    {
      ...
      element: (
        <SecondaryButton
          dataCy="workloads-tab-settings-button-refresh"
    ...
    },
    {
      ...
      element: (
        <SecondaryButton
          dataCy="workloads-tab-settings-button-revert"
    ...
    },
    {
      ...
      element: (
        <SecondaryButton
          dataCy="workloads-tab-settings-button-save"
          isDisabled={!props.isModified || isDataLoading}
      ...
      <Sidebar isPanelRight>
        <SidebarPanel variant="sticky">
          ...
          <JumpLinks
            ...
            scrollableSelector="#workload-page"
            ...
            <FlexItem flex={{ default: "flex_1" }}>
              <Form className="pf-v6-u-mb-lg">
                <FormGroup label="Name" role="group">
                  <IpaTextContent
                    dataCy="workloads-tab-settings-textbox-cn"
                    name={"cn"}
                    ariaLabel={"Name"}
                    ipaObject={ipaObject}
                ...
                <FormGroup label="Enabled" fieldId="oauth2enabled">
                  <IpaTextInput
                    dataCy="workloads-tab-settings-textbox-oauth2enabled"
                    name={"oauth2enabled"}
                    ariaLabel={"Enabled"}
                    ipaObject={ipaObject}
                    onChange={recordOnChange}
          ...
          <Flex direction={{ default: "column", lg: "row" }}>
            <FlexItem flex={{ default: "flex_1" }}>
              <Form className="pf-v6-u-mb-lg">
                ...
                >
                  <IpaTextInput
                    dataCy="workloads-tab-settings-textbox-oauth2maxtokenlifetime"
          ...
          <Flex direction={{ default: "column", lg: "row" }}>
            <FlexItem flex={{ default: "flex_1" }}>
              <Form className="pf-v6-u-mb-lg">
                ...
                >
                  <IpaTextArea
                    dataCy="workloads-tab-settings-textarea-oauth2workloadskill"
                ...
                >
                  <IpaNumberInput
                    dataCy="workloads-tab-settings-number-oauth2workloadcardttl"
                ...
                <FormGroup fieldId="preview-card">
                  <Button
                    ...
                    data-cy="workloads-tab-settings-button-preview-card"
                  >
                    Preview Card
                  </Button>
                </FormGroup>
                {cardPreview !== null && (
                  ...
                  >
                    <CodeBlock>
                      <CodeBlockCode data-cy="workloads-tab-settings-card-preview">
                        {cardPreview}
                      </CodeBlockCode>
                    </CodeBlock>
                  </FormGroup>
