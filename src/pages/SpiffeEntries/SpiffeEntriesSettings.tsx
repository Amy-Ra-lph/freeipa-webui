...
const SpiffeEntriesSettings = (props: PropsToSettings) => {
  ...
  const onRevert = () => {
    ...
    dispatch(
      addAlert({
        name: "revert-success",
        title: "SPIFFE entry data reverted",
        variant: "success",
      })
    );
  };
      ...
      if ("data" in response) {
        ...
        if (data?.result) {
          ...
          dispatch(
            addAlert({
              name: "success",
              title: "SPIFFE entry '" + props.workload.cn + "' updated",
              variant: "success",
            })
          );
          props.onResetValues();
  ...
  const toolbarFields = [
    {
      ...
      element: (
        <SecondaryButton
          dataCy="spiffe-entries-tab-settings-button-refresh"
    ...
    },
    {
      ...
      element: (
        <SecondaryButton
          dataCy="spiffe-entries-tab-settings-button-revert"
    ...
    },
    {
      ...
      element: (
        <SecondaryButton
          dataCy="spiffe-entries-tab-settings-button-save"
          isDisabled={!props.isModified || isDataLoading}
      ...
      <Sidebar isPanelRight>
        <SidebarPanel variant="sticky">
          ...
          <JumpLinks
            ...
            scrollableSelector="#spiffe-entry-page"
            expandable={{ default: "expandable", md: "nonExpandable" }}
            className="pf-v6-u-mt-md"
          >
            <JumpLinksItem key={0} href="#spiffe-id-settings">
              SPIFFE ID
            </JumpLinksItem>
            <JumpLinksItem key={1} href="#general-settings">
              General
            </JumpLinksItem>
            <JumpLinksItem key={2} href="#identity-settings">
              Identity
            </JumpLinksItem>
            <JumpLinksItem key={3} href="#token-settings">
              Token settings
            </JumpLinksItem>
            <JumpLinksItem key={4} href="#agent-card-settings">
              Agent Card
            </JumpLinksItem>
          </JumpLinks>
        </SidebarPanel>
            ...
            <FlexItem flex={{ default: "flex_1" }}>
              <Form className="pf-v6-u-mb-lg">
                <FormGroup label="SPIFFE ID" fieldId="oauth2spiffeid">
                  <IpaTextInput
                    dataCy="spiffe-entries-tab-settings-textbox-oauth2spiffeid"
                    name={"oauth2spiffeid"}
                    ariaLabel={"SPIFFE ID"}
                    ipaObject={ipaObject}
            ...
            <FlexItem flex={{ default: "flex_1" }}>
              <Form className="pf-v6-u-mb-lg">
                <FormGroup label="Name" role="group">
                  <IpaTextContent
                    dataCy="spiffe-entries-tab-settings-textbox-cn"
                    name={"cn"}
                    ariaLabel={"Name"}
                    ipaObject={ipaObject}
                    objectName="oauth2workload"
                ...
                <FormGroup label="Type" fieldId="oauth2workloadtype">
                  <IpaTextInput
                    dataCy="spiffe-entries-tab-settings-textbox-oauth2workloadtype"
                ...
                <FormGroup label="Description" fieldId="description">
                  <IpaTextInput
                    dataCy="spiffe-entries-tab-settings-textbox-description"
                    name={"description"}
            ...
            <FlexItem flex={{ default: "flex_1" }}>
              <Form className="pf-v6-u-mb-lg">
                <FormGroup label="Owner" fieldId="oauth2workloadowner">
                  <IpaTextInput
                    dataCy="spiffe-entries-tab-settings-textbox-oauth2workloadowner"
                ...
                >
                  <IpaTextInput
                    dataCy="spiffe-entries-tab-settings-textbox-oauth2workloadclient"
                ...
                >
                  <IpaTextInput
                    dataCy="spiffe-entries-tab-settings-textbox-oauth2workloadserviceprincipal"
          ...
          <Flex direction={{ default: "column", lg: "row" }}>
            <FlexItem flex={{ default: "flex_1" }}>
              <Form className="pf-v6-u-mb-lg">
                ...
                >
                  <IpaTextInput
                    dataCy="spiffe-entries-tab-settings-textbox-oauth2maxtokenlifetime"
          ...
          <Flex direction={{ default: "column", lg: "row" }}>
            <FlexItem flex={{ default: "flex_1" }}>
              <Form className="pf-v6-u-mb-lg">
                ...
                >
                  <IpaTextArea
                    dataCy="spiffe-entries-tab-settings-textarea-oauth2workloadskill"
                ...
                >
                  <IpaNumberInput
                    dataCy="spiffe-entries-tab-settings-number-oauth2workloadcardttl"
                ...
                <FormGroup fieldId="preview-card">
                  <Button
                    ...
                    data-cy="spiffe-entries-tab-settings-button-preview-card"
                  >
                    Preview Card
                  </Button>
                </FormGroup>
                {cardPreview !== null && (
                  ...
                  >
                    <CodeBlock>
                      <CodeBlockCode data-cy="spiffe-entries-tab-settings-card-preview">
                        {cardPreview}
                      </CodeBlockCode>
                    </CodeBlock>
                  </FormGroup>
...
export default SpiffeEntriesSettings;
